...
//method to pay student fees
payStudent_fees(student_id:number, amount:number){
    let student = this.find_student(student_id);
    if(student){
...
showStudent_status(student_id:number){
    let student = this.find_student(student_id);
    if(student){student.show_status()}
}
...
message : "Enter a Student ID"
   ...
   case "Exit":console.log("You have successfully Exited");
   process.exit();
